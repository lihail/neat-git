...
export async function getCurrentBranch(repoPath: string): Promise<string> {
  ...
  try {
    const branch = await window.ipcRenderer.invoke('git:currentBranch', repoPath);
    return branch || 'main';
  } catch (error) {
...
export async function listBranches(repoPath: string): Promise<Branch[]> {
  ...
  try {
    const branches = await window.ipcRenderer.invoke('git:listBranches', repoPath);
    return branches || [];
  } catch (error) {
...
export async function listRemoteBranches(repoPath: string): Promise<Branch[]> {
  ...
  try {
    const branches = await window.ipcRenderer.invoke('git:listRemoteBranches', repoPath);
    return branches || [];
  } catch (error) {
 ...
 */
export async function commit(repoPath: string, message: string, description?: string): Promise<{ success: boolean; sha: string }> {
  if (typeof window === 'undefined' || !window.electronAPI) {
    console.warn('Electron API not available');
  ...
  try {
    const result = await window.ipcRenderer.invoke('git:commit', repoPath, message, description);
    return result;
  } catch (error) {
 ...
 */
export async function stash(repoPath: string, message: string): Promise<{ success: boolean; message: string }> {
  if (typeof window === 'undefined' || !window.electronAPI) {
    console.warn('Electron API not available');
  ...
  try {
    const result = await window.ipcRenderer.invoke('git:stash', repoPath, message);
    return result;
  } catch (error) {
...
export async function listStashes(repoPath: string): Promise<Stash[]> {
  ...
  try {
    const stashes = await window.ipcRenderer.invoke('git:listStashes', repoPath);
    return stashes || [];
  } catch (error) {
 ...
 */
export async function popStash(repoPath: string, index: number): Promise<{ success: boolean; message: string }> {
  if (typeof window === 'undefined' || !window.electronAPI) {
    console.warn('Electron API not available');
    return { success: false, message: 'Electron API not available' };
  }
  ...
  try {
    const result = await window.ipcRenderer.invoke('git:popStash', repoPath, index);
    return result;
  } catch (error) {
 ...
 * Delete a stash
 */
export async function deleteStash(repoPath: string, index: number): Promise<{ success: boolean; message: string }> {
  if (typeof window === 'undefined' || !window.electronAPI) {
    console.warn('Electron API not available');
    return { success: false, message: 'Electron API not available' };
  }
  ...
  try {
    const result = await window.ipcRenderer.invoke('git:deleteStash', repoPath, index);
    return result;
  } catch (error) {
 ...
 */
export async function stageLines(repoPath: string, filepath: string, lines: DiffLine[]): Promise<void> {
  if (typeof window === 'undefined' || !window.electronAPI) {
    console.warn('Electron API not available');
    return;
  }
  ...
  try {
    await window.ipcRenderer.invoke('git:stageLines', repoPath, filepath, lines);
  } catch (error) {
 ...
 */
export async function unstageLines(repoPath: string, filepath: string, lines: DiffLine[]): Promise<void> {
  if (typeof window === 'undefined' || !window.electronAPI) {
    console.warn('Electron API not available');
    return;
  }
  ...
  try {
    await window.ipcRenderer.invoke('git:unstageLines', repoPath, filepath, lines);
  } catch (error) {
...
export async function fetchFromRemote(
  ...
  try {
    ...
    const result = await window.ipcRenderer.invoke('git:fetch', safeRepoPath, safeUsername, safePassword, safeSaveCredentials);
    return result;
  } catch (error) {
...
export async function pushToRemote(
  ...
  try {
    ...
    const result = await window.ipcRenderer.invoke('git:push', safeRepoPath, safeUsername, safePassword, safeSaveCredentials);
    return result;
  } catch (error) {
...
export async function pullFromRemote(
  ...
  try {
    ...
    const result = await window.ipcRenderer.invoke('git:pull', safeRepoPath, safeUsername, safePassword, safeSaveCredentials);
    return result;
  } catch (error) {
