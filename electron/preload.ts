...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  discardChanges: (repoPath: string, filepath: string, oldFilePath?: string | null) =>
    ipcRenderer.invoke(IPC_CHANNELS.GIT_DISCARD_CHANGES, repoPath, filepath, oldFilePath),
  stageLines: (
    repoPath: string,
    filepath: string,
